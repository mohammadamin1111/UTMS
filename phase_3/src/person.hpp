...
public:
    ...
    virtual void show_information_courses(string &html) {}
    void delete_course(int id);
    void has_exam_conflict(string exam_date);
    virtual void show_personal_page(vector<Major *> majors , string &html) = 0;
    ...
    string get_photo_adress(){ return photo_adress;};
protected:
    string id;
    string name;
    string password;
...
public:
    ...
    void show_information_courses(string &html);
    void show_personal_page(vector<Major *> majors , string &html);
